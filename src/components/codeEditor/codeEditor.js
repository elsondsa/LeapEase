...
function CodeEditor() {
  ...
  const [code, setCode] = React.useState(app.appData.modules["0b61ee0"].output.customCode);
  ...
  return (
    <div>
      <Typography>Upload your application here:</Typography>
      ...
      >
        ...
        {appInfo && appInfo != '' && Object.keys(appInfo.appData.modules).map((element, id, arr) =>
          <option value={element}>{element}</option>)
        }
      </Select>
      <Button variant="contained" color="primary" onClick={handleSaveModule}>
        Save Module
      </Button>
      <Button variant="contained" color="primary" onClick={handleSaveApp}>
        Save App
      </Button>
      <AceEditor
        width="100%"
